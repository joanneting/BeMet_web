...
//    	Hibernate 設定
    ...
    @Bean
    public TransactionInterceptor BeMettransactionInterceptor() {
//    	交易攔截器，設定 service method 交易行為
    ...
    public DefaultPointcutAdvisor defaultPointcutAdvisor() {
        ...
        expression.setExpression("execution(* tw.com.BeMet.service.*.*(..))");
        return new DefaultPointcutAdvisor(expression, BeMettransactionInterceptor());
    }
