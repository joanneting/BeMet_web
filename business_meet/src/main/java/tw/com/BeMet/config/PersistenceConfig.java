...
//    	Hibernate 設定
    ...
    @Bean
    public TransactionInterceptor BusinessMeettransactionInterceptor() {
//    	交易攔截器，設定 service method 交易行為
    ...
    public DefaultPointcutAdvisor defaultPointcutAdvisor() {
        ...
        expression.setExpression("execution(* tw.com.business_meet.service.*.*(..))");
        return new DefaultPointcutAdvisor(expression, BusinessMeettransactionInterceptor());
    }
